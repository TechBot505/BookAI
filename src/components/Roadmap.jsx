...
function Roadmap() {
  return (
    <div className="dark:bg-gradient-to-r from-start to-end bg-gray-100  py-8">
      <div id='roadmap' class="max-w-6xl bg-white dark:bg-secondary dark:bg-opacity-80 mx-auto pb-4 font-[sans-serif] rounded-xl">
