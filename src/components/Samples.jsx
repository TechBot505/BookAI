...
function Samples() {
  return (
    <div class=" dark:bg-primary font-[sans-serif] bg-gray-100 px-4 py-12 pb-20">
      <div class="max-w-5xl max-lg:max-w-3xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 max-sm:max-w-sm max-sm:mx-auto mt-12">
          ...
          <div class="bg-white shadow rounded-3xl p-6 hover:-translate-y-3 transition-all duration-300">
