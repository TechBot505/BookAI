...
function Navbar() {
  ...
  return (
    <nav className="bg-gray-50 border-gray-200 dark:bg-primary">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 py-8">
        ...
        <label class="inline-flex items-center cursor-pointer">
          ...
          <button
            type="button"
            className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-blue-800"
          >
            Get started
          </button>
          <button
